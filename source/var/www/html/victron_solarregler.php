...
do {
  ...
  ****************************************************************************/
  ...
  if ($rc == ":4AAAAFD") {  // Es wird ein Framefehler gemeldet.
    $rc = $funktionen->ve_regler_auslesen($USB1,":".$Befehl.$funktionen->VE_CRC($Befehl));
  }
  ...
  $Befehl = "7ADED00";  //  Verbraucherstrom
  $rc = $funktionen->ve_regler_auslesen($USB1,":".$Befehl.$funktionen->VE_CRC($Befehl));
  if ($rc == ":4AAAAFD") {  // Es wird ein Framefehler gemeldet.
    $rc = $funktionen->ve_regler_auslesen($USB1,":".$Befehl.$funktionen->VE_CRC($Befehl));
  }
...
$funktionen->log_schreiben("---------   Stop   victron_solarregler.php   ----------------- ","|--",6);

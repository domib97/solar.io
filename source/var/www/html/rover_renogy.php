...
do {
  ...
  ****************************************************************************/
  ...
  $funktionen->log_schreiben("0014 : ".$rc,"   ",7);
  if ($rc === false) {
    continue;
  }
  $Version = $funktionen->renogy_daten($rc,false,false);
  $aktuelleDaten["Firmware"] = substr($Version,2);
...
$funktionen->log_schreiben("---------   Stop   rover_regler.php    ---------------------- ","|--",6);

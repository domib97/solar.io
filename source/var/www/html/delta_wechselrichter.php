...
/*******************
require_once($Pfad."/phpinc/crc16.php");
if ( ($obj instanceof Crc16) != true ) {
...
do {
  ...
  ****************************************************************************/
  ...
  $aktuelleDaten["Variant"] = substr($Daten,6,2)+0;
  $aktuelleDaten["Modell"] = $funktionen->Hex2String(substr($Daten,8,-4));
  ...
  if ($aktuelleDaten["Variant"] == 1) {
    $Framedaten["Command"] = "6001"; // Daten auslesen Variant 1 SW Type 1

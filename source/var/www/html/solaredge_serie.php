...
do {
  ...
  ****************************************************************************/
  ...
  $aktuelleDaten["M1_AC_Soannung_S"] = $funktionen->solaredge_faktor(hexdec(substr($rc,322,4)),$aktuelleDaten["M1_AC_Spannung_Faktor"]);
  ...
  $funktionen->log_schreiben("40295: ".$rc,"+  ",10);

  $aktuelleDaten["Befehl"] = substr($rc,14,2);

  if ( $aktuelleDaten["Befehl"] <> 83)   {
    ...
    $aktuelleDaten["M2_AC_Soannung_S"] = $funktionen->solaredge_faktor(hexdec(substr($rc,322,4)),$aktuelleDaten["M2_AC_Spannung_Faktor"]);
  ...
  $funktionen->log_schreiben("404695: ".$rc,"+  ",10);
  ...
  if ( $aktuelleDaten["Befehl"] <> 83)   {
    ...
    $aktuelleDaten["M3_AC_Soannung_S"] = $funktionen->solaredge_faktor(hexdec(substr($rc,322,4)),$aktuelleDaten["M3_AC_Spannung_Faktor"]);
  ...
  if ($aktuelleDaten["M1_AC_Gesamtleistung"] > 0) {
    ...
    if (($aktuelleDaten["AC_Verbrauch"] - $aktuelleDaten["AC_Bezug"]) > 0) {
      $aktuelleDaten["PV_Leistung"] = ($aktuelleDaten["AC_Leistung"]);
    }
    else {
  ...
  ****************************************************************************/
  ...
  $funktionen->log_schreiben("AC_Leistung: ".$aktuelleDaten["AC_Leistung"],"   ",7);
  $funktionen->log_schreiben("DC_Leistung: ".$aktuelleDaten["DC_Leistung"],"   ",7);
  $funktionen->log_schreiben("Bezug/+Einspeisung: ".$aktuelleDaten["M1_AC_Gesamtleistung"],"   ",7);
  $funktionen->log_schreiben("Verbrauch: ".$aktuelleDaten["AC_Verbrauch"],"   ",7);

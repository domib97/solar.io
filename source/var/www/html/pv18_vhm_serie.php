...
//
//  Es dient dem Auslesen der Regler der PV18 3KW VHM Serie über die USB
...
$funktionen->log_schreiben("-------------   Start  pv18.php  ----------------------------- ","|--",6);
...
do {
  ...
  ****************************************************************************/
  ...
  $funktionen->log_schreiben("Maschinentyp: PV".$aktuelleDaten["Maschinentype"],"   ",6);
  // Laderegler
  ...
  $Befehl["RegisterAddress"] = "6291";   // Dezimal 25233
  $Befehl["RegisterCount"] = "0001";
  $rc = $funktionen->phocos_pv18_auslesen($USB1,$Befehl);
  $aktuelleDaten["AC_Temperatur"] = $funktionen->hexdecs($rc["data"]);
...
$funktionen->log_schreiben("-------------   Stop   pv18.php    --------------------------- ","|--",6);
